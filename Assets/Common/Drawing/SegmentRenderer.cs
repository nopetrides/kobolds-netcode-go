...
namespace Common.Unity.Drawing
{
    ...
    public enum LineMode { Lines, Triangles, Quads, Tetrahedron, Pentagons, Hexagons };
    ...
    public class SegmentRenderer : BaseRenderer
    {
        ...
        private List<LineMode> LineModes { get; set; }
        ...
        {
            Load(vertices, null, LineMode.Lines);
        }

        public void Load(IList<Vector2> vertices, IList<int> indices, LineMode mode = LineMode.Lines)
        {
        ...
        public void Load(IList<Vector2> vertices, IList<Color> colors, IList<int> indices = null, LineMode mode = LineMode.Lines)
        {
            var primative = new RenderPrimative();
            primative.Mode = mode;
        ...
        public void Load(IList<Vector2> vertices, Color color, IList<int> indices = null, LineMode mode = LineMode.Lines)
        {
            var primative = new RenderPrimative();
            primative.Mode = mode;
        ...
        public void Load(Vector2 a, Vector2 b, LineMode mode = LineMode.Lines)
        {
            var primative = new RenderPrimative();
            primative.Mode = mode;
        ...
        public void Load(Vector2 a, Vector2 b, Color color, LineMode mode = LineMode.Lines)
        {
            var primative = new RenderPrimative();
            primative.Mode = mode;
        ...
        public void Load(IList<Vector3> vertices, IList<int> indices, LineMode mode = LineMode.Lines)
        {
            var primative = new RenderPrimative();
            primative.Mode = mode;
        ...
        public void Load(IList<Vector3> vertices, IList<Color> colors, IList<int> indices = null, LineMode mode = LineMode.Lines)
        {
            var primative = new RenderPrimative();
            primative.Mode = mode;
        ...
        public void Load(IList<Vector3> vertices, Color color, IList<int> indices = null, LineMode mode = LineMode.Lines)
        {
            var primative = new RenderPrimative();
            primative.Mode = mode;
        ...
        public void Load(Vector3 a, Vector3 b, LineMode mode = LineMode.Lines)
        {
            var primative = new RenderPrimative();
            primative.Mode = mode;
        ...
        public void Load(Vector3 a, Vector3 b, Color color, LineMode mode = LineMode.Lines)
        {
            var primative = new RenderPrimative();
            primative.Mode = mode;
        ...
        public void Load(IList<Vector4> vertices, IList<int> indices = null, LineMode mode = LineMode.Lines)
        {
            var primative = new RenderPrimative();
            primative.Mode = mode;
        ...
        public void Load(IList<Vector4> vertices, IList<Color> colors, IList<int> indices = null, LineMode mode = LineMode.Lines)
        {
            var primative = new RenderPrimative();
            primative.Mode = mode;
        ...
        public void Load(IList<Vector4> vertices, Color color, IList<int> indices = null, LineMode mode = LineMode.Lines)
        {
            var primative = new RenderPrimative();
            primative.Mode = mode;
        ...
        public void Load(Vector4 a, Vector4 b, LineMode mode = LineMode.Lines)
        {
            var primative = new RenderPrimative();
            primative.Mode = mode;
        ...
        public void Load(Vector4 a, Vector4 b, Color color, LineMode mode = LineMode.Lines)
        {
            var primative = new RenderPrimative();
            primative.Mode = mode;
