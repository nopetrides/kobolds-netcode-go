...
namespace FIMSpace.Jiggling
{
    ...
    public class FJiggling_Simple : FJiggling_Base
    {
        ...
        /// <summary> If you want to change grow animations target scale. </summary>
        public void OverwriteInitialScale(Vector3 scale) { initScale = scale; }
        ...
        protected override void Init()
        {
            ...
            if (initScale == Vector3.zero) initScale = Vector3.one;
