...
namespace FIMSpace.Basics
{
    ...
    public class FBasic_FheelekController : FBasic_RigidbodyMovement
    {
        ...
        protected override void Jump()
        {
            ...
            if (horizontalValue != 0f && verticalValue == 0f) CharacterRigidbody.linearVelocity += new Vector3(-newVelocityRight.z, 0f, newVelocityRight.x);
        ...
        protected override void StoppingMovement()
        {
            ...
            CharacterRigidbody.linearVelocity = new Vector3(vel.x * accelerationForward, CharacterRigidbody.linearVelocity.y, vel.z * accelerationForward);
            targetVelocity = CharacterRigidbody.linearVelocity;
