...
#endif
    public class ThirdKoboldControllerLean : MonoBehaviour
    {
        [Header("Player")]
        ...
        private void Move()
        {
            ...
            if (_input.move != Vector2.zero)
            {
				...
				_directBlendDelay += Time.deltaTime * DirectBlendAccelerationMultiplier;
            }
			else
			{
				_directBlendDelay -= Time.deltaTime * DirectBlendDecelerationMultiplier;
			}
			_directBlendDelay = Mathf.Clamp(_directBlendDelay, DirectBlendMin, DirectBlendMax);
			
			// overriding unity logic https://www.youtube.com/watch?v=hBWjYiW85u0
